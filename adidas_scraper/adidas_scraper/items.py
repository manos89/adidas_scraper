...
class AdidasScraperItem(scrapy.Item):
    ...
    id_color = scrapy.Field(output_processor=TakeFirst())
    id_size = scrapy.Field(output_processor=TakeFirst())
    id_model = scrapy.Field(output_processor=TakeFirst())
    size_chart_link = scrapy.Field(output_processor=TakeFirst())
